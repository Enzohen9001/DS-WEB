...
async function requisicaoHello(){
  ...
  divResposta.innerHTML = "Status: " + resposta.status + "<br>" + "Menssage: " + resposta.message
}
...
async function requisicaoEcho(){
    ...
    divResposta.innerHTML = "Status: " + resposta.status + "<br>" + "Menssage: " + resposta.echo.message
}